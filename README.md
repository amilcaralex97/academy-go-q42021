...
- The items in the CSV must have an ID element (int value) x
...
- Clean architecture proposal x
- Use best practices x
- Handle the Errors **_(CSV not valid, error connection, etc)_** x
...
- Create a client to consume an external API x
- Add an endpoint to consume the external API client x
